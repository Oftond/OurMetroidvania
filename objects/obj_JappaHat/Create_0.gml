...
death=spr_death;
attack_mask=spr_JappaHat_Attack_mask;
Attacks=[{name:"hit",damage:7,animation:attack, distance_to_attack:(sprite_width / 2) + 20, attack_hitbox:attack_mask, attack_method:HitAttack}];
