...
show_info_item = function(_item)
{
	...
	draw_sprite_ext(_item.icon, 0, bbox_right - 300, bbox_top + 150 + (sprite_get_height(_item.icon) * 2), 2, 2, 0, c_white, 1);
	draw_set_font(global.Description);
	draw_text_ext(bbox_right - 300, bbox_top + 100 + (sprite_get_height(_item.icon) * 4), _item.description, 30, 500)
}
